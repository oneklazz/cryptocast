...
Полная документация проекта (спецификация, архитектура, диаграммы) собирается с помощью MkDocs:
...
- [Главная страница](docs/index.md) - общее описание микросервиса
- [Спецификация](docs/specification.md) - требования и сценарии использования
- [Архитектура](docs/architecture.md) - описание компонентов и их взаимодействия
- [Предметная область](docs/domain.md) - основные сущности и бизнес-правила
- [Диаграммы](docs/diagrams/) - context, use-case, sequence (Mermaid)

## Пакет core

Библиотека `cryptocast-core` опубликована на TestPyPI:
https://test.pypi.org/project/cryptocast-core/0.2.0/
